...
The core objective of **AI Agent Monitoring Center** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(275, 85%, 60%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(195, 90%, 50%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(350, 80%, 55%)` - Callouts and interactive states.
