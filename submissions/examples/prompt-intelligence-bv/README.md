...
The core objective of **Prompt Intelligence Platform** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(35, 95%, 50%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(210, 85%, 55%)` - Secondary metrics lines.
